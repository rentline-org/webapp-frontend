  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'grid grid-cols-1 rounded-lg sm:rounded-xl md:rounded-md',
        ...
        >
          ...
          <div className='grid grid-cols-1 rounded-lg p-1 shadow-md sm:rounded-xl sm:p-1.5 md:rounded-4xl md:p-2'>
